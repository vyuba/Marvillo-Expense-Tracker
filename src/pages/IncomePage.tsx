    ...
    <div className="w-full relative">
      ...
      <div className="flex flex-row w-full items-center justify-between">
        ...
        >
          ...
          <span>upload Income </span>
        </button>
      </div>
      {documents?.length > 0 ? (
        <>
          <div className="w-full">
            <div className="w-full rounded-md flex px-2 py-3 my-5 bg-[#0D0D0D]"></div>
                  ...
                  <tbody>
                    {documents.map((data) => (
                      ...
                      >
                        ...
                        <td
                          onClick={() => {
                            const myPromise = handleDelete(data.$id);
